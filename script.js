const questions = [
    ...
    },
    {
        ...
        correctAnswers: ["процедурная", "по совпадению", "логическая", "временная", "функциональная", "коммуникативная"]
    },
    {
    ...
    },
    {
        ...
        correctAnswers: ["Трудности контроля и управления временем разработки", "Повышенные требования к заказчику"]
    },
    {
