const questions = [
    ...
    },
    {
        ...
        correctAnswers: ["тестирование начинается на начальных этапах разработки"]
    },
    {
    ...
    },
    {
        ...
        correctAnswers: ["Трудности контроля и управления временем разработки", "Сложность реализации для больших проектов",  "Высокая зависимость системы от качества анализа рисков", "Повышенные требования к заказчику"]
    },
    {
